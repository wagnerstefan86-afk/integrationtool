...
def generate_report(
    ...
    if calibration and calibration.outcomes_analyzed > 0:
        ...
        s.append(
            f"**Prediction Accuracy:** {calibration.accuracy_rate:.0%} "
        ...
        if calibration.systematic_biases:
            s.append("### Where the Model Was Wrong")
            s.append("")
            s.append("Systematic biases detected across multiple outcomes:")
            s.append("")
    ...
    # --- Footer ---
    s.append("---")
    s.append("*Report generated by harmonizer v0.6.0*")
